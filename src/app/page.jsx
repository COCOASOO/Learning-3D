...
export default function Home() {
  return (
    <div className="font-sans bg-green-100 min-h-screen">
      {/* Header Section */}
      <header className="bg-gradient-to-r from-teal-600 to-green-600 text-white text-center py-20">
        ...
        <button className="bg-white text-teal-600 font-semibold py-3 px-8 rounded-full hover:bg-gray-200 transition duration-300">
          Get Started
        </button>
      </header>
      ...
      <section className="py-20">
        <h2 className="text-4xl font-semibold text-center text-teal-600 mb-12">Features</h2>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 px-6">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden transform transition duration-300 hover:scale-105">
            <div className="p-6">
              <h3 className="text-2xl font-bold mb-4 text-teal-600">Create Playlists</h3>
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden transform transition duration-300 hover:scale-105">
            <div className="p-6">
              <h3 className="text-2xl font-bold mb-4 text-teal-600">Share with Friends</h3>
              <p className="text-gray-600">
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden transform transition duration-300 hover:scale-105">
            <div className="p-6">
              <h3 className="text-2xl font-bold mb-4 text-teal-600">Rate Videos</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-green-100">
        <h2 className="text-4xl font-semibold text-center text-teal-600 mb-12">How It Works</h2>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 px-6">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold mb-2 text-teal-600">Create</h3>
            <p className="text-gray-600">
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold mb-2 text-teal-600">Share</h3>
            <p className="text-gray-600">
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold mb-2 text-teal-600">Rate</h3>
            <p className="text-gray-600">
